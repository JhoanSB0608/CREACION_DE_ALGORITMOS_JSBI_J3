...
def update():
    ...
    while (bandera):
        ...
        read (codigo)
        print("""
        ¿ Estas seguro que deseas actualizar el camper ?
        1. Si
        2. No
        3. Cancelar
        """)
...
def delete():
    ...
    while bandera:
        ...
        ++++++++++++++++++++++++++
        """)
        codigo = int(input("¿Cuál es el código del camper que desea eliminar?: "))
        
        if 0 <= codigo - 1 < len(camper):
            val = camper[codigo - 1]

            print(f"""
            ¿Estás seguro que deseas eliminar el camper?
            1. Si
            2. No
            3. Cancelar
            """)
